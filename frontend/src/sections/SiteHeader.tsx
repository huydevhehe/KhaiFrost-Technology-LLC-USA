  ...
  return (
    <header
      className={`fixed inset-x-0 top-0 z-50 transition-colors duration-300 ${
        scrolled
          ? "border-b border-white/10 bg-navy/40 shadow-md backdrop-blur-md"
          : "border-b border-transparent bg-transparent"
      }`}
      style={{ viewTransitionName: "site-header" }}
    >
      <div className="mx-auto flex max-w-[1800px] items-center justify-between px-8 py-2.5 md:px-12">
